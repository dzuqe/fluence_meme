...
- Aqua manages the definition of workflows whereas marine is a wasm execution environment.
...
- Developers can earn Fluence's native token from their software usage.  The network-wide licensing system maintains a global network of application dependencies, access rights, and pricing.
...
- You write your applications in the Aqua language which gets compiled into an intermediate representation (AIR). This in turn is executed directly on MarineVM wasm runtime.
...
- To disrupt traditional platforms with a new open and decentralized runtime where you can host applications such as oracles and all these are managed internally by a registry that has licensing and pricing information.
